...
const TYPE_KEYWORDS_SEED: { key: string; subType?: string; words: string[]; weight: number }[] = [
  ...
  { key: "plumbing", words: ["رطوبة","رطوبه","تبلل","مياه أمطار","امطار","هطول","مطر"], weight: 3 },
  { key: "plumbing", subType: "صرف صحي", words: ["صفاية","تصريف","فتحة تصريف","مجرور","جرجور","بيارة","صرف صحي","مجاري"], weight: 3 },
  { key: "plumbing", subType: "صرف صحي", words: ["رائحة","روائح","ريحة","ريحه","رائحه","رائحة كريهة","روائح كريهة","رائحة الحمام","رائحة سيئة"], weight: 5 },
  { key: "plumbing", subType: "تسريبات مياه", words: ["رشح","نشف","بلل","رطوبة","تنقط","ينقط","يقطر","قطرة","يهرب","بقعة مياه","أثر مياه"], weight: 4 },
  { key: "plumbing", subType: "تسريبات مياه", words: ["تسريب مياه","تهريب مياه","كسر ماسورة","ماسورة مكسورة","خزان يسرب","خزان يهرب"], weight: 5 },
  { key: "plumbing", subType: "خزانات", words: ["خزان","الخزان","خزانات","غطاء خزان","رقبة الخزان","خزان أرضي","خزان علوي","تعبئة خزان","الخزان فارغ","الخزان ممتلئ"], weight: 5 },
  { key: "plumbing", subType: "مضخات", words: ["مضخة","دينمو","طلمبة","ضغط مياه","ضغط الماء","مو راضي يطلع","الماء ضعيف","مافيه ماء"], weight: 5 },
  { key: "plumbing", subType: "مضخات", words: ["عوامة","العوامة","المضخة لا تعمل","المضخة عطلانة","الدينمو عطلان"], weight: 5 },
