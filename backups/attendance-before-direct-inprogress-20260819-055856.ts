  ...
  try {
    ...
    const result = await prisma.$transaction(async (tx) => {
      ...
      for (const ticket of eligibleTickets) {
         ...
         * IMPORTANT:
         *
         * Claiming an appointment must NOT start the actual work.
         *
         * Correct lifecycle:
         *
         * CLAIMED
         ...
         *   -> COMPLETED
         *
         * Therefore Appointment Claim only creates a CLAIMED session.
         */
        ...
        /*
         * Keep the ticket aligned with the existing application
         * workflow. The Ticket status becomes in_progress when the
         * session is claimed, while the TicketTimeSession itself
         * remains CLAIMED until the technician starts travelling.
         */
