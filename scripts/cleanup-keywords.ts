...
// Words that describe LOCATION or CONTEXT — not the actual problem.
...
const LOCATION_GENERICS = new Set([
  ...
  "فله","فيلا","كراج","مدخل","ممر","ارضيه","سيراميك",
  ...
  "جديد","قديم","كثير",
  // Generic verbs / actions (not maintenance-specific)
  "اعاده","اغلاق","فتح","تاكد","اعمال","تنظيف","ملاحظات","استلام",
  "تجمع","توجيه","امل",
  // Filler words that passed stop-word filter
  "بلاط","جدار","مياه","علوي","اثناء","انه","اللي","كما","مما",
  "لكم","فراغات","دوره","رجال","عدد","صور","صوره","صوت","عزل",
  "غطاء","شباك","ميول","تصريف","انترلوك","افياش","ترويبه",
  "تطبيل","طيبه","فتحه","ارضي","اكثر",
]);
